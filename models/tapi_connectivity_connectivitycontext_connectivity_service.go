...
func (m *TapiConnectivityConnectivitycontextConnectivityService) UnmarshalJSON(raw []byte) error {
	...
	// AO2
	var aO2 TapiEthConnectivityServiceAugmentation1
	if err := swag.ReadJSON(raw, &aO2); err != nil {
		return err
	}
	m.TapiEthConnectivityServiceAugmentation1 = aO2
...
func (m TapiConnectivityConnectivitycontextConnectivityService) MarshalJSON() ([]byte, error) {
	...
	aO2, err := swag.WriteJSON(m.TapiEthConnectivityServiceAugmentation1)
	if err != nil {
		return nil, err
	}
...
func (m *TapiConnectivityConnectivitycontextConnectivityService) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with TapiEthConnectivityServiceAugmentation1
	if err := m.TapiEthConnectivityServiceAugmentation1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *TapiConnectivityConnectivitycontextConnectivityService) validateConnection(formats strfmt.Registry) error {
...
func (m *TapiConnectivityConnectivitycontextConnectivityService) validateConnectivityConstraint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityConnectivitycontextConnectivityService) validateResilienceConstraint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityConnectivitycontextConnectivityService) validateRoutingConstraint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityConnectivitycontextConnectivityService) validateTopologyConstraint(formats strfmt.Registry) error {
