...
// TapiCommonGetserviceinterfacepointlistOutput tapi common getserviceinterfacepointlist output
// swagger:model tapi.common.getserviceinterfacepointlist.Output
...
// Validate validates this tapi common getserviceinterfacepointlist output
...
func (m *TapiCommonGetserviceinterfacepointlistOutput) validateSip(formats strfmt.Registry) error {
		...
		if m.Sip[i] != nil {
			if err := m.Sip[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("sip" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
