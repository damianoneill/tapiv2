...
// TapiOamOamcontextOamService tapi oam oamcontext oam service
// swagger:model tapi.oam.oamcontext.OamService
type TapiOamOamcontextOamService struct {
...
func (m *TapiOamOamcontextOamService) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiOamOamcontextOamService) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi oam oamcontext oam service
func (m *TapiOamOamcontextOamService) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiOamOamcontextOamService) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiOamOamcontextOamService) validateMeg(formats strfmt.Registry) error {
...
func (m *TapiOamOamcontextOamService) validateOamServicePoint(formats strfmt.Registry) error {
...
func (m *TapiOamOamcontextOamService) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiOamOamcontextOamService) UnmarshalBinary(b []byte) error {
	var res TapiOamOamcontextOamService
